...
INSTALLED_APPS = [
    ...
    'django.contrib.staticfiles',
     'CftApp',  # Ajout de l'application 'CftApp'
     'corsheaders',  # Ajout de l'application 'corsheaders'
     'rest_framework',
...
WSGI_APPLICATION = 'cft.wsgi.application'
#AUTH_USER_MODEL = 'CftApp.CUser'
